...
import com.ZuWay.atapter.BannerOfferProductAdapter;
...
import com.ZuWay.atapter.SubBannerTitleAdapter;
...
public class BannerCategoryActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{

    SubcateGritAdapter subcateGritAdapter;
    SubBannerTitleAdapter subTitleAdapter;
    CarouselView customCarouselView;
    List<Productmodel> apiSliderList = new ArrayList<>();
    Productmodel sliderModel = new Productmodel();
    String cid,scid,pid,offer;
    ...
    ViewListener viewListener = new ViewListener() {
        ...
        public View setViewForPosition(int position) {
            ...
            Glide.with(getApplicationContext())
                    .load(url)
                    .placeholder(R.drawable.logo_200)
                    .into(fruitImageView);
    ...
    public  void init(){
        ...
        item_gv            = findViewById(R.id.item_gridviewimage1);
        ...
        lin_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(edit.isEmpty()&&edit==null){
                    ...
                    Intent intent=new Intent(BannerCategoryActivity.this,ItemListActivity.class);
        ...
        Shader textShader  = new LinearGradient(0, 0, 0, wish.getTextSize(),
                new int[]{
                        Color.parseColor("#f761a1"), Color.parseColor("#8c1bab")
                }, null, Shader.TileMode.CLAMP);
        wish.setTextColor(getResources().getColor(R.color.appcolordarkyellow));
        wish.getPaint().setShader(textShader);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent intent = new Intent(BannerCategoryActivity.this, HomeActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_gallery) {
            Intent intent = new Intent(BannerCategoryActivity.this, MyOrderActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_slideshow) {
            Intent intent = new Intent(BannerCategoryActivity.this, MyAccount.class);
            startActivity(intent);

        } else if (id == R.id.nav_tools) {
            Intent intent = new Intent(BannerCategoryActivity.this, MyWishActivity.class);
            startActivity(intent);

        }  else if (id == R.id.nav_shipping) {
            Intent intent = new Intent(BannerCategoryActivity.this, ShippingandRetrun.class);
            startActivity(intent);

        } else if (id == R.id.nav_privacy) {
            Intent intent = new Intent(BannerCategoryActivity.this, PrivacyPolicy.class);
            startActivity(intent);

        } else if (id == R.id.nav_terms) {
            Intent intent = new Intent(BannerCategoryActivity.this, TermsandContidion.class);
            startActivity(intent);

        } else if (id == R.id.nav_contact) {
            Intent intent = new Intent(BannerCategoryActivity.this, ContactUs.class);
            startActivity(intent);

        } else if (id == R.id.nav_about) {
            Intent intent = new Intent(BannerCategoryActivity.this, AboutUs.class);
            startActivity(intent);
    ...
    private void loadproduct() {
        ...
        String par_str    = "?type=" + "2";
        String par_str1   = "&offer=" + offer;
        String baseUrl    = ProductConfig.all_products + par_str + par_str1;
                        ...
                        try {
                            ...
                            if (jsonResponse.has("result") && jsonResponse.getString("result").equals("Success")) {
                                ...
                                for (int i = 0; i < jsonResarray.length(); i++) {
                                    ...
                                    BannerOfferProductAdapter itemGritHomeAdapter = new BannerOfferProductAdapter(BannerCategoryActivity.this, R.layout.banner_offfer_list_items, itemGritModelList);
                                    item_gv.setAdapter(itemGritHomeAdapter);
                                    item_gv.setNestedScrollingEnabled(false);
                                    item_gv.setExpanded(true);
                                    final LayoutAnimationController controller = AnimationUtils.loadLayoutAnimation(BannerCategoryActivity.this, R.anim.layout_animation);item_gv.setLayoutAnimation(controller);
    ...
    private void logout() {
        ...
        BSession.getInstance().destroy(BannerCategoryActivity.this);
        Toast.makeText(BannerCategoryActivity.this, getResources().getString(R.string.logout_success), Toast.LENGTH_SHORT).show();
        Intent intent = new Intent(BannerCategoryActivity.this, LoginActivity.class);
                ...
                try {
                    ...
                    if (jsonResponse.has("result") && jsonResponse.getString("result").equals("Success")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            fruitAdapter = new FruitAdapter(BannerCategoryActivity.this, R.layout.custom_row, spinnerList);
...
/*
                                            ...
                                            if (spinnerList.get(position).getCate_id().equals("0")) {
                                                    ...
                                                    Intent intent = new Intent(getApplicationContext(), BannerCategoryActivity.class);
                                                    intent.putExtra("scid", scid);
                                                    intent.putExtra("cid", cid);
                                                    auto_search.setText("");
                                                    startActivity(intent);
                        ...
                        try {
                            ...
                            if (jsonResponse.has("result") && jsonResponse.getString("result").equals("Success")) {
                                ...
                                for (int i = 0; i < jsonResarray.length(); i++) {
                                    ...
                                    subcateGritAdapter = new SubcateGritAdapter(BannerCategoryActivity.this, R.layout.layout_subcate, subcatemodellist);
                    ...
                    if (jsonResponse.has("result") && jsonResponse.getString("result").equals("Success")) {
                        ...
                        for (int i = 0; i < array.length(); i++) {
                            ...
                            if (product.getJSONArray("list").length() != 0) {
                                ...
                                LinearLayoutManager layoutManager = new LinearLayoutManager(BannerCategoryActivity.this, LinearLayoutManager.VERTICAL, false);
                                subtitlery.setLayoutManager(layoutManager);
                                subtitlery.setNestedScrollingEnabled(false);
                                subTitleAdapter = new SubBannerTitleAdapter(BannerCategoryActivity.this, subtitlemodellist);
  ...
  /*  @Override
    ...
    public void onStop() {
       ...
       /* if(mFocusDuringOnPause) {
            ...
            Intent intent=new Intent(BannerCategoryActivity.this,BannerCategoryActivity.class);
            intent.putExtra("cid",cid);
            startActivity(intent);
            ...
            Toast.makeText(BannerCategoryActivity.this, "off", Toast.LENGTH_SHORT).show();
