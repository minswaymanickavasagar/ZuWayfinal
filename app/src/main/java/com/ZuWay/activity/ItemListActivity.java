...
public class ItemListActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    String scid, cid,pid,key="",product_name="";
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent intent = new Intent(ItemListActivity.this, MyOrderActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_slideshow) {
            Intent intent = new Intent(ItemListActivity.this, MyAccount.class);
            startActivity(intent);

        } else if (id == R.id.nav_tools) {
            Intent intent = new Intent(ItemListActivity.this, MyWishActivity.class);
            startActivity(intent);

        }  else if (id == R.id.nav_shipping) {
            Intent intent = new Intent(ItemListActivity.this, ShippingandRetrun.class);
            startActivity(intent);

        } else if (id == R.id.nav_privacy) {
            Intent intent = new Intent(ItemListActivity.this, PrivacyPolicy.class);
            startActivity(intent);

        } else if (id == R.id.nav_terms) {
            Intent intent = new Intent(ItemListActivity.this, TermsandContidion.class);
            startActivity(intent);

        } else if (id == R.id.nav_contact) {
            Intent intent = new Intent(ItemListActivity.this, ContactUs.class);
            startActivity(intent);

        } else if (id == R.id.nav_about) {
            Intent intent = new Intent(ItemListActivity.this, AboutUs.class);
            startActivity(intent);
    ...
    private void logout() {
        ...
        BSession.getInstance().destroy(ItemListActivity.this);
        Toast.makeText(ItemListActivity.this, getResources().getString(R.string.logout_success), Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (jsonResponse.has("result") && jsonResponse.getString("result").equals("Success")) {
                                ...
                                for (int i = 0; i < jsonResarray.length(); i++) {
                                    ...
                                    itemGritHomeAdapter = new ItemGritHomeAdapter(ItemListActivity.this, R.layout.layout_item_home, itemGritModelList);
                                    item_gv.setAdapter(itemGritHomeAdapter);
                                    item_gv.setNestedScrollingEnabled(false);
                                    item_gv.setExpanded(true);
                                    final LayoutAnimationController controller = AnimationUtils.loadLayoutAnimation(ItemListActivity.this, R.anim.layout_animation);item_gv.setLayoutAnimation(controller);
    ...
    private void loadkeyword() {
        ...
        String par_str1   = "&user_id=" + userid;
        String par_str2   = "&product_name=" + product_name;
        System.out.println("para"+par_str2);
        System.out.println("para"+par_str1);
        System.out.println("para"+par_str);

        String baseUrl    = ProductConfig.loadkeyword + par_str +par_str1+par_str2;
        final StringRequest jsObjRequest = new StringRequest(Request.Method.GET, baseUrl,
                new Response.Listener<String>() {
                    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
                    @Override
                ...
                try {
                    ...
                    if (jsonResponse.has("result") && jsonResponse.getString("result").equals("Success")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            fruitAdapter = new FruitAdapter(ItemListActivity.this, R.layout.custom_row, spinnerList);
                            ...
                            auto_search.setOnItemClickListener(
                                    new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            ...
                                            Intent intent = new Intent(ItemListActivity.this, ItemListActivity2.class);
                                            intent.putExtra("scid", scid);
                                            intent.putExtra("cid", cid);
                                            intent.putExtra("pid", pid);
