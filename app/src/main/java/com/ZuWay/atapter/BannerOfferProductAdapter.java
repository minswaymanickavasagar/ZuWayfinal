...
public class BannerOfferProductAdapter extends ArrayAdapter<Productmodel> {
    ...
    public BannerOfferProductAdapter(Context context, int layoutResourceId, List<Productmodel> itemgritmodellist) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            ...
            holder.wishlidt_img = (ImageView) row.findViewById(R.id.wish_img);
            holder.tv_offer =  row.findViewById(R.id.tv_offer);
        ...
        holder.tv_offer.setText(item.getOffer()+" %"+"\n"+"OFF");
    ...
    static class RecordHolder {
        ...
        TextView item_name,tv_offer, item_disprice, item_oldprice, item_saveprice, wishlist_count;
